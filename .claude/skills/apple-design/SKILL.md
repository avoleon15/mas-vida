...
> **Nota para este proyecto:** todos los ejemplos de código de arriba son de web (CSS/JS). La traducción de cada sección a Flutter/Dart está en [`references/flutter.md`](references/flutter.md).
