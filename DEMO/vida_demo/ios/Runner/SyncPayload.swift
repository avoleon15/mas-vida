...
/// completo — esté o no dentro de una sesión.
...
/// esa lógica es del backend y no debe ser visible para el cliente.
///
...
struct RespuestaSincronizacion: Codable {
    ...
    let nivel: Int
    /// Total de pasos del día, ya deduplicado por fuente en el servidor. Es
    /// el número que hay que mostrarle al usuario ("pasos de hoy") porque
    /// coincide con lo que realmente le generó puntos.
